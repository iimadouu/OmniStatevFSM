...
- **NEW**: 🔍 Intelligent auto-recovery from generated code files
...
- Preserves workflow flexibility - edit in visual editor OR code editor
...
First public release of OmniState Visual AI - Professional visual state machine editor for Godot 4.x!
...
#### Code Generation
- **Professional structure** - Clean, organized output
